...
[노션 링크](https://www.notion.so/307df84d989e8053a04cf1bb1ab093c4?source=copy_link)

이 레포지토리는 전자책 **「어느 순간 무너지는 리액트 프로젝트」**에 수록된 예제 코드를 정리한 저장소입니다.
...
단, Chapter 1의 일부 예제는 ch1/server를 함께 실행해야 합니다.

# 실습 방법

Stpe 1. 실습하고 싶은 code-x-x 형식의 예제 폴더로 이동합니다.
...
Step 2. 해당 폴더의 README를 참고하여 실행합니다.

일반적으로 다음과 같은 방식으로 실행됩니다.
...
> ※ Chapter 1의 일부 예제(code-1-2 ~ code-1-6)는 ch1/server를 함께 실행해야 합니다.  
